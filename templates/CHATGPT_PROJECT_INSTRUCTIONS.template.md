...
Entscheidungen in den zuständigen Repository-/Issue-/PR-Quellen festhalten. Rückfragen nur bei relevanten noch offenen Entscheidungen, Pakete sinnvoll statt künstlich klein schneiden. Übergabeprompts kompakt und direkt kopierbar in einen Codeblock setzen.

Modellwahl und Eigenumsetzung ausschließlich für noch anstehende Implementierung gemäß der eingebundenen `MODEL_SELECTION.md` bewerten. Keine rückblickende Empfehlung nach erledigter Arbeit. Reviews auf konkrete Code-Stände und tatsächliche Belege stützen; technische Blocker, offene Abnahmen und optionale Verbesserungen trennen.
